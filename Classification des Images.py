...
#Utiliser un dictionnaire pour mapper les classes resultante et utiliser les predictions
results={
   0:'aeroplane',
   1:'automobile',
   2:'bird',
...
# l’image d’entrée doit prendre la forme d’un ensemble de données, c’est-à-dire (32,32,3)
